                ...
                {mentionTools
                  ...
                  .map((tool) => (
                    ...
                    >
                      ...
                      <p className="ml-2  block sm:inline text-md sm:text-lg font-semibold  ">
                        @{tool.name}
                      </p>
                    </li>
                  ))}
          ...
          >
            <div className="relative flex flex-col w-full overflow-hidden max-h-60 grow  bg-gray-100 border sm:px-2">
              ...
              <Textarea
                ...
                className={`w-full resize-none bg-transparent px-4 py-[1.3rem] focus-within:outline-none sm:text-sm   pr-[45px] ${
